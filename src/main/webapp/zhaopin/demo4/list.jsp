            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <tr id="product1">
                        ...
                        <td>                        
							<c:if test="${resume.interviewType==4}">建议录用</c:if>
							<c:if test="${resume.interviewType==5}"> 录用</c:if>
						</td>
						
						<td>
						<c:if test="${resume.interviewType==4 }">
							<a href="resume/queryResumeById3.do?id=${resume.resumeId}">面试结果</a>						   
							<a href="../../pmag/demo1/add.html">入职办理</a>
						</c:if>
						
						<c:if test="${resume.interviewType==5 }">
							<a href="../../pmag/demo1/add.html">入职办理</a>
						</c:if>
						</td> 
                    <tr>
