...
<base href="<%=basePath%>">
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="resume/updateInterview2.do" method="post">
			...
			<tr>
                ...
                <tr>
                    <td>决议时间：<input value="${interview.interviewDecisionTime }"></td>
                    <td>
                     录用决议：<textarea cols="70" rows="3">${interview.interviewDecision }</textarea>
                    </td>                
                </tr>
				 <tr>
