        ...
        <input type="hidden" name="pxId" value="${px.pxId }" />
            <table border="1" width="100%" class="table_a">
                <tr>
                    ...
                    <td><input type="text" name="pxName" value="${ px.pxName}" readonly="readonly"/></td>
                </tr>
                <tr>
                    <td>培训讲师<span style="color:red">*</span>：</td>
                    <td>
                       <input type="text" name="pxJiangshi" value="${ px.pxJiangshi}" readonly="readonly"/> 
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
						<input type="text" name="pxTime" value="${ px.pxTime}" readonly="readonly"/></td>
                </tr>
                <tr>
                    <td>至</td>
                    <td>
                    <input type="text" readonly name="pxEnd" value="${ px.pxEnd}" readonly="readonly"/>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="pxMudi" readonly="readonly">${ px.pxMudi}</textarea>
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <textarea name="pxCxry" readonly="readonly">${ pxCxry}</textarea>
                    </td>                
                </tr>
				...
				<tr>
                    <td>培训简介：</td>
                    <td>
                        <textarea name="pxJianjie" readonly="readonly">${ px.pxJianjie}</textarea>
                    </td>                
                </tr>
